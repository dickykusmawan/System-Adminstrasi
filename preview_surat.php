...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO surat_table (tanggal, nomor_surat, dari_jabatan, department, jumlah_lampiran, kepada_jabatan, tembusan_jabatan, perihal, dasar_surat, maksud_tujuan, sistem, waktu_pelaksanaan, penutup, status_surat) 
                VALUES ('$tanggal', '$nomor_surat', '$dari_jabatan', '$department', '$jumlah_lampiran', '$kepada_jabatan', '$tembusan_jabatan', '$perihal', '$dasar_surat', '$maksud_tujuan', '$sistem', '$waktu_pelaksanaan', '$penutup', '$status_surat')";
        ...
        echo '<td class="tanggal">Nomor : ' . $nomor_surat . '</td>';
//      echo '<td class="tanggal">' . $nama . '</td>';
        ...
        echo '<td class="nomor_surat">Jumlah Lampiran : ' . $jumlah_lampiran . '</td>';
//      echo '<td class="tanggal">' . $nama . '</td>';
        echo '</tr>';
...
//      echo '<td class="tanggal">' . $nama . '</td>';
        ...
        echo '<div class="isi">';
        echo '<p> <h3>Dasar : </h3>';
        if (isset($_POST['dasar_surat'])) {
            $inputValue = $_POST['dasar_surat'];
...
<div class="dw_topdf">
<form action="cek_riwayat_surat.php" method="post">
