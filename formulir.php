...
<body>
    <h2>Formulir Buat Proposal</h2>
    <form action="preview.php" method="post">
        <label for="tanggal">Tanggal :</label>
        <input type="date" name="tanggal" required>
        <br>
        <label for="nomor_proposal">Nomor Proposal :</label>
        <input type="text" name="nomor_proposal" required>
        <br>
        <!-- Tombol Cek Riwayat Proposal -->
        <input type="button" value="Cek Riwayat" onclick="document.location.href='cek_riwayat_proposal.php'"/> 
        <br><br>       
        ...
        <br>
        <label for="dasar_proposal">Dasar : </label>
        <br>
        <textarea name="dasar_proposal" id="dasar_proposal" required ></textarea>
        <br>
