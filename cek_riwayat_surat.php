...
<body>
    <div class="form-container">
        <h1 style="text-align: center;">Riwayat Surat</h1>
        <table>
            <tr>
                <th>No</th>
            ...
            if ($result->num_rows > 0) {
                ...
                //    echo "<td>".$count."</td>";
                    ...
                    if(empty($row['status_manager'])){
                        ...
                        echo "<button onclick=\"approveSurat('" . $row['id'] . "')\">Approve</button>";
                    ...
                    if(empty($row['status_direktur'])){
                        echo "<td>";
                        echo "<button onclick=\"lihatStatus('".$row['id']."')\">Lihat</button>";
                        echo "<button onclick=\"approveSurat2('" . $row['id'] . "')\">Approve</button>";
                    ...
                    if(empty($row['status_head_operasional'])){
                        echo "<td>";
                        echo "<button onclick=\"lihatStatus('".$row['id']."')\">Lihat</button>";
                        echo "<button onclick=\"approveSurat3('" . $row['id'] . "')\">Approve</button>";
                    ...
                    if(empty($row['status_presdir'])){
                        echo "<td>";
                        echo "<button onclick=\"lihatStatus('".$row['id']."')\">Lihat</button>";
                        echo "<button onclick=\"approveSurat4('" . $row['id'] . "')\">Approve</button>";
            ...
            <script>
                ...
                function approveSurat(id) {
                    ...
                    console.log("Approving proposal with nomor_surat:", id);
                    ...
                    xhttp.open("POST", "update_status_surat.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send("nomor_surat=" + id + "&status=" + statusValue);
                }

                function approveSurat2(id) {
                    // Send an AJAX request to update the status in the database to "Approved"
                    console.log("Approving proposal with nomor_surat:", id);
                    var statusValue = "Approved " + currentTime;
                    ...
                    xhttp.open("POST", "update_status2_surat.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send("nomor_surat=" + id + "&status=" + statusValue);
                }

                function approveSurat3(id) {
                    // Send an AJAX request to update the status in the database to "Approved"
                    console.log("Approving proposal with nomor_surat:", id);
                    var statusValue = "Approved " + currentTime;
                    ...
                    xhttp.open("POST", "update_status3_surat.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send("nomor_surat=" + id + "&status=" + statusValue);
                }

                function approveSurat4(id) {
                    // Send an AJAX request to update the status in the database to "Approved"
                    console.log("Approving proposal with nomor_surat:", id);
                    var statusValue = "Approved " + currentTime;
                    ...
                    xhttp.open("POST", "update_status4_surat.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send("nomor_surat=" + id + "&status=" + statusValue);
                }
                ...
                function tolakProposal(id) {
                    ...
                    console.log("Tolak proposal with nomor_surat:", id);
                    ...
                    xhttp.open("POST", "update_status_tolak_surat.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send("nomor_surat=" + id + "&status=" + statusValue);
                }
                ...
                function tolakProposal2(id) {
                    ...
                    xhttp.open("POST", "update_status_tolak2_surat.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send("nomor_surat=" + id + "&status=" + statusValue);
                }
                ...
                function tolakProposal3(id) {
                    ...
                    xhttp.open("POST", "update_status_tolak3_surat.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send("nomor_surat=" + id + "&status=" + statusValue);
                }
                ...
                function tolakProposal4(id) {
                    ...
                    xhttp.open("POST", "update_status_tolak4_surat.php", true);
                    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhttp.send("nomor_surat=" + id + "&status=" + statusValue);
                }
                ...
                function lihatStatus(id) {
                    // Send an AJAX request to update the status in the database to "ditolak"
                    window.location.href = "preview2_surat.php?id=" + id;
                }
        ...
        <footer>
            <div class="button-row">
                <input type="button" value="Buat Surat" onclick="document.location.href='surat.php'"/>
